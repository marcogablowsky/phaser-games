MagGame = {
    ...
    /* Your game can check MagGame.orientated in internal loops to know if it should pause or not */
    orientated: false

};

MagGame.Boot = function (game) {
};

MagGame.Boot.prototype = {
